...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-primary">
            ...
            <div class="container mt-3">
                ...
                <div class="card-body">
                    <a  class="btn btn-success"href="/tugas_uas/dosen/tambah.php">Tambahkan Data</a>
                ...
                <?php while($row = mysqli_fetch_array($hasil)) { ?>
                    <tr>
                        ...
                        <div class="btn-group">
                        <a href="/tugas_uas/dosen/edit.php?dosen_id=<?php echo $row['dosen_id']; ?>">
                                <button class=" btn btn-warning" style="margin-right:20px;">Edit</button>
                            </a>
                            <button class="btn btn-danger "onclick="hapusData('<?php echo $row['dosen_id']; ?>')">Hapus</button>
                        </div>
                        </td>
                    </td>
                    </tr>
        ...
        function hapusData(dosen_id) {
            if (confirm("Anda yakin ingin menghapus data dengan Dosen ID: " + dosen_id + "?")) {
                fetch("hapus.php?dosen_id=" + encodeURIComponent(dosen_id), {
                    method: "DELETE"
                })
